<script lang="ts">
	...
	// Form validation
	let isValid = $derived(data.name?.trim());
</script>
...
<div class="min-h-screen bg-background p-6">
	<div class="mx-auto max-w-2xl space-y-8">
		...
		<div class="flex">
			...
			<div class="basis-full space-y-2 text-center">
				<h1 class="text-3xl font-bold tracking-tight text-foreground">Update Project</h1>
				<p class="text-muted-foreground">Update sandbox testing environment</p>
			</div>
		</div>
			...
			<Card class="shadow-lg">
				...
				<CardContent class="space-y-6">
					...
					<div class="space-y-2">
						...
						<Select.Root type="single" bind:value={data.simulation_mode} name="simulationMode">
