...
<span class="mt-4 text-lg font-bold">C2B parameters</span>
<span class="text-sm">
...
<div class="grid grid-cols-4 items-center gap-4">
	...
	<Input id="validationUrl" type="text" class="col-span-3" bind:value={validation_url} />
</div>
<div class="grid grid-cols-4 items-center gap-4">
	<Label for="confirmationUrl" class="text-right">Confirmation URL</Label>
	<Input id="confirmationUrl" type="text" class="col-span-3" bind:value={confirmation_url} />
</div>
